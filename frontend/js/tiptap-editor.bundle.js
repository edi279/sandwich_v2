var TiptapEditor = (() => {
  ...
  // public/js/tiptap-editor.js
  var tiptap_editor_exports = {};
  __export(tiptap_editor_exports, {
    initTiptapEditor: () => initTiptapEditor
  });
...
${nextLine.slice(indentLevel + 2)}`;
  ...
  var index_default4 = Youtube;

  // public/js/tiptap-editor.js
  var CustomYouTube = index_default4.extend({
    addPasteRules() {
      return [
        {
          ...
          handler: ({ state, range, match }) => {
            ...
            const { tr: tr2 } = state;
            tr2.replaceWith(range.from, range.to, this.type.create({ src: `https://www.youtube.com/embed/${videoId}` }));
          }
        }
      ];
    }
  });
  function initTiptapEditor(element, options = {}) {
  ...
  return __toCommonJS(tiptap_editor_exports);
})();
